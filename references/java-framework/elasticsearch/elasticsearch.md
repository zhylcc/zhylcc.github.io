...
# 7. 将student_index_v1 数据拷贝到 student_index_v2
...
![1575626474666](.\img\1575626474666.png)
...
#### 10.1. 3 修改elasticsearch.yml配置文件
...
![1575630754009](img\1575630754009.png)

```shell
vim /opt/elasticsearch-7.4.0-itcast1/bin/elasticsearch
```

![1575631078654](img\1575631078654.png)
...
![1575630948133](img\1575630948133.png)
...
![1575631033297](img\1575631033297.png)



启动成功访问节点一：

![1575628494844](img\1575628494844.png)

可以从日志中看到：master not discovered yet。还没有发现主节点

访问集群状态信息 http://192.168.149.135:9201/_cat/health?v 不成功

![1575628567827](img\1575628567827.png)

启动成功访问节点二:

![1575628735672](img\1575628735672.png)
...
![1575628812009](img\1575628812009.png)
...
![1575628972101](img\1575628972101.png)

可以看到节点已经变为3个，至此，ES集群已经搭建成功~



### 10.2  使用Kibana配置和管理集群
...
![1575629869248](img\1575629869248.png)

#### 10.2.2 管理集群

1、打开Kibana，点开 Stack Monitoring 集群监控

![1575630589113](img\1575630589113.png)

![1575631125143](img\1575631125143.png)

2、点击【Nodes】查看节点详细信息

![1575631203718](img\1575631203718.png)





![1575631303974](img\1575631303974.png)
...
![1574607430115](.\img\1574607430115.png)
...
![1574607864042](.\img\1574607864042.png)
...
![1574609255103](.\img\1574609255103.png)

通过上图我们可以看到elasticsearch已经成功启动


## 11.2 访问elasticsearch
...
![1574609539550](.\img\1574609539550.png)
...
![1574610511959](.\img\1574610511959.png)
...
![1574610669598](.\img\1574610669598.png)
...
![1571160484991](.\img\1571160484991.png)
...
![1571160606899](.\img\1571160606899.png)
...
![1571160954958](.\img\1571160954958.png)
...
![1571161497433](.\img\1571161497433.png)

查看grunt版本

![1571161600969](.\img\1571161600969.png)
...
![1571161083235](.\img\1571161083235.png)
...
![1571193736229](.\img\1571193736229.png)
...
![1571163304853](.\img\1571163304853.png)

5) 访问head

浏览器输入ip:port:9100，如下图

![1571163462191](.\img\1571163462191.png)
